...
with sync_playwright() as p:
    ...
    page.goto('http://127.0.0.1:5008/admin/docker', wait_until='networkidle')
    page.evaluate("""() => {
        localStorage.setItem('bytesec-theme', 'dark');
        var html = document.getElementById('html-root');
        if (html) html.classList.add('dark');
    ...
    page.wait_for_timeout(500)
    page.screenshot(path=r'C:\Users\FRTX\ByteSec\screenshots_dark\admin_docker_tabs.png', full_page=True)
    print('OK')
    browser.close()
